...
// Editor look actions. Everything the maker changes to the STAGED draft (never
// live): stageLook writes the look into the draft, publishStore promotes it,
// resetStore discards it. Ownership is enforced via getCurrentShop before any
// write. The legacy commitLook (writes straight to live) is retired when the
// editor stops calling it. Spec: Editor-Make-It-Yours-Design.md Part 1.
...
export type ActionResult = UseLookResult;
