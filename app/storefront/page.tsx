...
export default async function StorefrontHomePage({
  ...
  searchParams: Promise<{ previewToken?: string; previewLook?: string; previewMood?: string; previewTexture?: string; previewTextureOpacity?: string; hero?: string; goods?: string; about?: string; nav?: string; collections?: string; reviews?: string; findus?: string }>;
}) {
