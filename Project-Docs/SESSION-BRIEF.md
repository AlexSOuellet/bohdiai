...
**Branch:** `session-12/layout-engine`. This session's work committed on top of Session 17's two commits. `mood.designDirection` wiring is the next action.
