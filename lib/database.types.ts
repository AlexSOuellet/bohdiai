  ...
  public: {
    Tables: {
      ...
      design_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "design_tokens_restored_from_snapshot_id_fkey"
      ...
      editor_history: {
        Row: {
          ...
          created_at: string
          design_tokens_snapshot_id: string | null
          id: string
          prompt: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "editor_history_design_tokens_snapshot_id_fkey"
            columns: ["design_tokens_snapshot_id"]
            isOneToOne: false
            referencedRelation: "design_tokens"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "editor_history_reverted_by_history_id_fkey"
            columns: ["reverted_by_history_id"]
            isOneToOne: false
            referencedRelation: "editor_history"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "editor_history_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      page_blocks: {
        Row: {
          ...
          content: Json
          created_at: string
          created_by_history_id: string | null
          id: string
          is_visible: boolean
          last_updated_by_history_id: string | null
          page_id: string
          position: number
          tenant_id: string
          updated_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "page_blocks_created_by_history_id_fkey"
            columns: ["created_by_history_id"]
            isOneToOne: false
            referencedRelation: "editor_history"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "page_blocks_last_updated_by_history_id_fkey"
            columns: ["last_updated_by_history_id"]
            isOneToOne: false
            referencedRelation: "editor_history"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "page_blocks_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
