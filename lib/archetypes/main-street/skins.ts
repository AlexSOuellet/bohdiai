...
export const MAIN_STREET_SKIN_TAGS: Record<string, SkinTag> = {
  ...
  'main-street-tannery': { world: 'Workshop', moods: ['rustic'] },
  'main-street-forge': { world: 'Workshop', moods: ['modern'] },
  ...
  'main-street-studio': { world: 'Studio', moods: ['modern'] },
  ...
  'main-street-pressroom': { world: 'Press', moods: ['modern'] },
  'main-street-marquee': { world: 'Press', moods: ['modern'] },
  'main-street-broadside': { world: 'Press', moods: ['modern'] },
