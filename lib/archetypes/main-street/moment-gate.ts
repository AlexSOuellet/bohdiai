/**
 * The Moment gate (D44). The Moment is a front-door, cold-arrival experience:
 * it plays ONLY when this visit *landed* on the home page and the visitor hasn't
 * entered before. Reaching home by clicking around inside the site does not
 * trigger it — a side-door (deep link / QR) arrival gets no Moment for the whole
 * visit, even on the way to home. Clicking "Enter site" is what writes the
 * do-not-replay cookie, so a returning visitor skips straight to the site.
 *
...
/** Whether the Moment should play on this load. */
